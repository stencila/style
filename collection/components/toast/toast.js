...
export class StencilaToast {
  ...
  render() {
    return (h(Host, { type: this.type, position: this.position, dismissable: this.dismissable, onMouseEnter: this.pauseAutoDismiss, onMouseLeave: this.autoDismiss },
      ...
      h("div", { class: "content" },
        ...
        h("slot", null),
        h("slot", { name: "actions" })),
      (this.dismissable || this.duration === 0) && (h("stencila-button", { color: "neutral", iconOnly: true, icon: "close", minimal: true, size: "small", onClick: this.dismiss, class: "closeButton" }))));
  }
