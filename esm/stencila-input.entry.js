...
const Input = class {
  ...
  render() {
    ...
    return (h(Host, { class: { inline: this.inline } }, this.iconStart !== undefined && (h("stencila-icon", { icon: this.iconStart })), h("input", Object.assign({}, _type, _label, { autoFocus: this.autoFocus, inputmode: this.inputmode, name: this.name, placeholder: this.placeholder, required: this.required, value: this.value }))));
  }
};
Input.style = {
...
export { Input as stencila_input };
