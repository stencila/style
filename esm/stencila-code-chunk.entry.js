import { r as registerInstance, c as createEvent, h, H as Host, a as getElement } from './index-e3052a43.js';
import { s } from './schema-d66ff4ac.js';
...
const CodeChunkComponent = class {
  ...
  async getContents() {
    ...
    if (this.editorRef) {
      ...
      return s({ text, programmingLanguage: language });
    }
    return s({ text: '' });
  }
  /**
