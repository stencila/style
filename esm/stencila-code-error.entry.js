...
const ErrorComponent = class {
  ...
  render() {
    ...
    return (h(Host, { kind: severity }, h("div", { class: "overview", onClick: this.toggleStackVisibility }, h("stencila-icon", { icon: this.getIcon(severity) }), h("slot", null)), this.hasStack && (h("stencila-details", { open: this.stackIsOpen }, h("slot", { name: "stacktrace" })))));
  }
