...
var dist$1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const toastController = (baseOptions = {}) => {
  const present = (message, options = {}) => {
    ...
    el.type = (_b = (_a = options.type) !== null && _a !== void 0 ? _a : baseOptions.type) !== null && _b !== void 0 ? _b : exports.ToastTypes.neutral;
    el.position =
      (_d = (_c = options.position) !== null && _c !== void 0 ? _c : baseOptions.position) !== null && _d !== void 0 ? _d : exports.ToastPositions.topCenter;
