...
const Details = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { isOpen: open, onClick: this.clickHandler }, index.h("slot", { name: "summary" }), index.h("div", { class: { contents: true, hidden: !open } }, index.h("slot", null)), index.h("stencila-icon", { icon: "arrow-down-s", class: "disclosure-toggle" })));
  }
};
Details.style = {
