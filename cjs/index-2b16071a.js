...
const index = require('./index-6720146a.js');
...
const tagStart = new index_es.ExternalTokenizer((input, token, stack) => {
...
const selfClosed = new index_es.ExternalTokenizer((input, token, stack) => {
...
const commentContent$1 = new index_es.ExternalTokenizer((input, token) => {
...
// This file was generated by lezer-generator. You probably shouldn't edit it.
const parser$1 = index_es.Parser.deserialize({
  version: 13,
  ...
  nodeProps: [
    [stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.NodeProp.closedBy, -2,1,2,"EndTag SelfCloseEndTag",11,"CloseTag"],
    [stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.NodeProp.openedBy, 5,"StartTag",18,"StartTag StartCloseTag",19,"OpenTag"]
  ],
  skippedNodes: [0,25],
  repeatNodeCount: 6,
...
const identifiers = new index_es.ExternalTokenizer((input, token) => {
...
const descendant = new index_es.ExternalTokenizer((input, token) => {
...
const unitToken = new index_es.ExternalTokenizer((input, token) => {
  let {start} = token;
...
const completeCSS = context => {
    let { state, pos } = context, node = stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.syntaxTree(state).resolve(pos, -1);
...
const cssLanguage = stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.LezerLanguage.define({
    parser: parser.configure({
        props: [
            stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.indentNodeProp.add({
                Declaration: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.continuedIndent()
            }),
            ...
            stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.styleTags({
                ...
                PseudoClassName: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.constant(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.className),
                ...
                ParenthesizedContent: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.special(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.name),
...
function completeHTML(context) {
    let { state, pos } = context, around = stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.syntaxTree(state).resolve(pos), tree = around.resolve(pos, -1);
...
`<style>` tags.
*/
const htmlLanguage = /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.LezerLanguage.define({
    parser: /*@__PURE__*/parser$1.configure({
        ...
        nested: /*@__PURE__*/configureNesting([
            { tag: "script",
                ...
                parser: index.javascriptLanguage.parser },
            { tag: "style",
                attrs(attrs) {
...
*/
function html() {
    return new stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.LanguageSupport(htmlLanguage, [htmlCompletion, index.javascript().support, css().support]);
}
