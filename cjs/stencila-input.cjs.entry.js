...
const Input = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: { inline: this.inline } }, this.iconStart !== undefined && (index.h("stencila-icon", { icon: this.iconStart })), index.h("input", Object.assign({}, _type, _label, { autoFocus: this.autoFocus, inputmode: this.inputmode, name: this.name, placeholder: this.placeholder, required: this.required, value: this.value }))));
  }
};
Input.style = {
